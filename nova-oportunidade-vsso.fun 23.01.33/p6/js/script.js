    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.t11 = getCookieByName('PHPSESSID');
          _context3.next = 16;
          return getClientId();
        case 16:
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          _context6.t2 = JSON;
          _context6.t3 = extractOrigin((_document2 = document) == null ? void 0 : _document2.referrer);
          ...
          _context6.t10 = getCookieByName('PHPSESSID');
...
function _onLoad() {
  _onLoad = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
    var trackingId, _document3, _URL2, _document4, src, currentScript, trackingType, _trackingId, productId, baseURL, isTrackingTypeValid, tracking, productData, _document5, sessionCookieExists, lastHistory, _queryParams, history, _queryParams2, session, queryParams, _error$response;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.prev = 0;
          Logger.info(JSON.stringify({
            referrer: extractOrigin((_document3 = document) == null ? void 0 : _document3.referrer)
          }));
        ...
        case 27:
          ...
          if (extractHostname((_document4 = document) == null ? void 0 : _document4.referrer) === window.location.hostname) {
            Object.assign(productData, _extends({}, formatUtms(extractUTMsFromQueryParams((_document5 = document) == null ? void 0 : _document5.referrer))));
          }
